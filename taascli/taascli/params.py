...
upgrade_update_parser.add_argument("-v", "--version", type=str)
upgrade_update_parser.add_argument("-d", "--product", type=str, default="fgt")
upgrade_update_parser.add_argument("-r", "--repo", type=str, default=None)
upgrade_update_parser.add_argument("-c", "--branch", type=str, default="")
upgrade_update_parser.add_argument("-b", "--build", type=int, default=0)
upgrade_update_parser.add_argument("-t", "--type", type=str, default="image")
upgrade_update_parser.add_argument("-i", "--ip", type=str)
upgrade_update_parser.add_argument("-u", "--username", type=str)
upgrade_update_parser.add_argument("-p", "--password", type=str, default="")
upgrade_update_parser.add_argument("-f", "--file", type=str, dest="file",
                                   default=None)
upgrade_update_parser.add_argument(
    "-n", "--file-pattern", type=str, default=None
)
upgrade_update_parser.add_argument(
...
upgrade_generate_parser = upgrade_sub_parsers.add_parser(
    "generate", help="generate sample config file"
)
